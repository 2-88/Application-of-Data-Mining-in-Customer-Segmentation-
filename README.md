...
RFM analysis, an association rule mining technique is a customer segmentation approach extensively employed in marketing and analytics to categorize customers based on their transactional patterns. Representing Recency, Frequency, and Monetary value, RFM assesses customers in terms of the time since their last purchase, how frequently they make purchases, and the total monetary value of their transactions. By scrutinizing these three dimensions, businesses can discern specific customer segments, such as high-value and loyal patrons, potentially at-risk customers, or those requiring reengagement. This method empowers marketers to fine-tune their strategies, enabling the delivery of personalized and targeted campaigns to diverse customer segments. The ultimate goal is to enhance customer satisfaction and optimize the effectiveness of marketing efforts by tailoring approaches to different customer behaviors.

RFM analysis is frequently combined with K-Means Clustering which is a data mining technique for customer segmentation, leveraging the complementary strengths of both methods. While RFM analysis illuminates customer behavior using recency, frequency, and monetary metrics as a foundation, K-Means Clustering enhances this approach by systematically grouping similar customers. By employing the algorithm to categorize customers into clusters based on their RFM attributes, businesses gain a more sophisticated understanding of patterns and trends within each group. This synergistic integration delivers a nuanced and data-driven segmentation, allowing marketers to refine strategies with greater precision according to the unique characteristics and needs of each customer cluster. The amalgamation of RFM analysis and K-Means Clustering thus optimizes the overall efficacy of customer segmentation, offering a comprehensive and actionable framework for targeted marketing initiatives.

The data used for the analysis is sourced from the UCI website: https://archive.ics.uci.edu/dataset/502/online+retail+ii
The dataset was a CRMS data of a UK-based registered non-online retail that captures all its transactions between 01/12/2010 to 09/12/2011. 
...
![](https://github.com/2-88/Application-of-Data-Mining-in-E-Commerce-Customer-Segmentation-/blob/main/Picture10.png).
